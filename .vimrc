...
augroup unwantedspaces
  autocmd!
  let s:blacklist = ['help', 'man', 'patch', 'tar']
...
let g:indent_guides_exclude_filetypes = ['help', 'man', 'patch', 'tar']
...
augroup spellcolors
  autocmd!
  let s:blacklist = ['applescript', 'help', 'man', 'matlab', 'octave', 'patch', 'tar', 'vim']
